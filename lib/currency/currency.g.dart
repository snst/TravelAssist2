...
const CurrencySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'state': PropertySchema(
      ...
      name: r'state',
      type: IsarType.byte,
      enumMap: _CurrencystateEnumValueMap,
    ),
...
Currency _currencyDeserialize(
  ...
  final object = Currency(
    ...
    state:
        _CurrencystateValueEnumMap[reader.readByteOrNull(offsets[1])] ??
        CurrencyStateEnum.show,
    value: reader.readDoubleOrNull(offsets[2]) ?? 1.0,
  );
  object.id = id;
  return object;
}
...
P _currencyDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_CurrencystateValueEnumMap[reader.readByteOrNull(offset)] ??
              CurrencyStateEnum.show)
          as P;
    case 2:
...
const _CurrencystateEnumValueMap = {'home': 0, 'show': 1, 'hide': 2};
const _CurrencystateValueEnumMap = {
  0: CurrencyStateEnum.home,
  1: CurrencyStateEnum.show,
  2: CurrencyStateEnum.hide,
};
...
extension CurrencyQueryFilter
  ...
  QueryBuilder<Currency, Currency, QAfterFilterCondition> stateEqualTo(
    CurrencyStateEnum value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Currency, Currency, QAfterFilterCondition> stateGreaterThan(
    CurrencyStateEnum value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Currency, Currency, QAfterFilterCondition> stateLessThan(
    CurrencyStateEnum value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Currency, Currency, QAfterFilterCondition> stateBetween(
    CurrencyStateEnum lower,
    CurrencyStateEnum upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension CurrencyQuerySortBy on QueryBuilder<Currency, Currency, QSortBy> {
  ...
  QueryBuilder<Currency, Currency, QAfterSortBy> sortByState() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'state', Sort.asc);
    });
  }

  QueryBuilder<Currency, Currency, QAfterSortBy> sortByStateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CurrencyQuerySortThenBy
  ...
  QueryBuilder<Currency, Currency, QAfterSortBy> thenByState() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'state', Sort.asc);
    });
  }

  QueryBuilder<Currency, Currency, QAfterSortBy> thenByStateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'state', Sort.desc);
    });
  }
...
extension CurrencyQueryWhereDistinct
  ...
  QueryBuilder<Currency, Currency, QDistinct> distinctByState() {
    return QueryBuilder.apply(this, (query) {
...
extension CurrencyQueryProperty
  ...
  QueryBuilder<Currency, CurrencyStateEnum, QQueryOperations> stateProperty() {
    return QueryBuilder.apply(this, (query) {
...
Currency _$CurrencyFromJson(Map<String, dynamic> json) => Currency(
  ...
  state:
      $enumDecodeNullable(_$CurrencyStateEnumEnumMap, json['state']) ??
      CurrencyStateEnum.show,
);
...
Map<String, dynamic> _$CurrencyToJson(Currency instance) => <String, dynamic>{
  ...
  'state': _$CurrencyStateEnumEnumMap[instance.state]!,
};

const _$CurrencyStateEnumEnumMap = {
  CurrencyStateEnum.home: 'home',
  CurrencyStateEnum.show: 'show',
  CurrencyStateEnum.hide: 'hide',
};
