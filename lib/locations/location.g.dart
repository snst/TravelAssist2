...
const LocationSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'tags': PropertySchema(id: 5, name: r'tags', type: IsarType.string),
...
extension LocationQueryFilter
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tagsEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tagsGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tagsLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tagsBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tagsStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tagsEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tagsContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tagsMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQuerySortBy on QueryBuilder<Location, Location, QSortBy> {
  ...
  QueryBuilder<Location, Location, QAfterSortBy> sortByTags() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tags', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> sortByTagsDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQuerySortThenBy
  ...
  QueryBuilder<Location, Location, QAfterSortBy> thenByTags() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tags', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> thenByTagsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tags', Sort.desc);
    });
  }
  ...
  QueryBuilder<Location, Location, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension LocationQueryWhereDistinct
  ...
  QueryBuilder<Location, Location, QDistinct> distinctByTitle({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQueryProperty
  ...
  QueryBuilder<Location, String, QQueryOperations> tagsProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
